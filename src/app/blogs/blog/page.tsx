                            ...
                            <div className="pl-[24px] mb-10">
                                ...
                                <ul className="flex flex-col space-y-3.5">
                                    ...
                                    <li className="flex space-x-5 items-center">
                                        ...
                                        <span className="text-[15px] text-black font-medium">There are many variations of passages</span>
                                    </li>
                                    ...
                                    <li className="flex space-x-5 items-center">
                                        ...
                                        <span className="text-[15px] text-black font-medium">All the Lorem Ipsum generators</span>
                                    </li>
                                    ...
                                    <li className="flex space-x-5 items-center">
                                        ...
                                        <span className="text-[15px] text-black font-medium">Asearch for &apos;lorem ipsum&apos; will uncover many</span>
                                    </li>
                                </ul>
                            </div>
                            <div className="comment-area w-full mt-4">
                                <div className="w-full sm:flex justify-between items-center mb-[30px]">
                                    <div className="tags flex space-x-5 items-center mb-5 sm:mb-0">
                                        ...
                                        <span className="text-base text-qgraytwo hover:text-qyellow">#Technology</span>
                                        <span className="text-base text-qgraytwo hover:text-qyellow">#Agency</span>
                                        <span className="text-base text-qgraytwo hover:text-qyellow">#Data</span>
                                    </div>
                                        ...
                                        <div className="flex space-x-2.5 items-center">
                                            <span className="text-base ">
                                                <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M34.5284 17.2744C34.5284 26.7975 26.799 34.5175 17.2642 34.5175C7.72946 34.5175 0 26.7975 0 17.2744C0 7.75127 7.72946 0.03125 17.2642 0.03125C26.799 0.03125 34.5284 7.75127 34.5284 17.2744Z" fill="#FFBB38"></path><path d="M20.7181 16.9846H18.6418V25H15.4961V16.9846H14V14.1677H15.4961V12.3448C15.4961 11.0412 16.0837 9 18.6698 9L21 9.01027V11.7446H19.3093C19.032 11.7446 18.6421 11.8906 18.6421 12.5124V14.1703H20.9929L20.7181 16.9846Z" fill="#222222">
                                                    </path>
                                                </svg>
                                            </span>
                                            <span className="text-base">
                                                <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M34.7433 17.2744C34.7433 26.7975 27.0138 34.5175 17.4791 34.5175C7.9443 34.5175 0.214844 26.7975 0.214844 17.2744C0.214844 7.75127 7.9443 0.03125 17.4791 0.03125C27.0138 0.03125 34.7433 7.75127 34.7433 17.2744Z" fill="#FFBB38"></path><path d="M25 13.4206C24.4483 13.6615 23.8548 13.8243 23.2324 13.8971C23.8679 13.5223 24.3555 12.9292 24.5857 12.2214C23.9911 12.5687 23.3322 12.8206 22.6315 12.9563C22.0701 12.3678 21.2703 12 20.3847 12C18.6854 12 17.3072 13.3567 17.3072 15.0294C17.3072 15.2669 17.3345 15.498 17.3873 15.7199C14.8297 15.5936 12.562 14.3876 11.044 12.5542C10.7792 13.0015 10.6272 13.5223 10.6272 14.0774C10.6272 15.1282 11.1709 16.0558 11.9962 16.5989C11.492 16.5833 11.0172 16.4471 10.6025 16.2196C10.6022 16.2325 10.6022 16.2454 10.6022 16.258C10.6022 17.7258 11.6635 18.9501 13.071 19.2282C12.813 19.2978 12.5406 19.3347 12.2604 19.3347C12.0616 19.3347 11.8691 19.3159 11.6814 19.2807C12.0729 20.4839 13.2092 21.3598 14.5561 21.3845C13.5027 22.1971 12.1759 22.6813 10.7337 22.6813C10.4859 22.6813 10.2403 22.667 10 22.6388C11.3612 23.4987 12.9792 24 14.717 24C20.3775 24 23.4731 19.3839 23.4731 15.3803C23.4731 15.249 23.4701 15.1182 23.4642 14.9885C24.0659 14.5615 24.5876 14.0281 25 13.4206Z" fill="#222222"></path>
                                                </svg>
                                            </span>
                                            <span className="text-base ">
                                                <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M34.9581 17.2744C34.9581 26.7975 27.2287 34.5175 17.6939 34.5175C8.15914 34.5175 0.429688 26.7975 0.429688 17.2744C0.429688 7.75127 8.15914 0.03125 17.6939 0.03125C27.2287 0.03125 34.9581 7.75127 34.9581 17.2744Z" fill="#FFBB38"></path><path d="M25 18.9697V24H21.9987V19.3068C21.9987 18.1284 21.5654 17.3236 20.4787 17.3236C19.6494 17.3236 19.1567 17.8654 18.9392 18.39C18.8602 18.5775 18.8398 18.8378 18.8398 19.1008V23.9998H15.8383C15.8383 23.9998 15.8786 16.051 15.8383 15.2282H18.84V16.4712C18.834 16.481 18.8255 16.4906 18.8201 16.4999H18.84V16.4712C19.2389 15.8748 19.9502 15.0222 21.545 15.0222C23.5196 15.0222 25 16.2759 25 18.9697ZM12.6984 11C11.6717 11 11 11.6549 11 12.5153C11 13.3575 11.6522 14.0313 12.659 14.0313H12.6785C13.7253 14.0313 14.3762 13.3575 14.3762 12.5153C14.3563 11.6549 13.7253 11 12.6984 11ZM11.1784 24H14.1788V15.2282H11.1784V24Z" fill="#222222">

                                                    </path>
                                                </svg>
                                            </span>
                                            <span className="text-base ">
                                                <svg width="36" height="35" viewBox="0 0 36 35" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M35.173 17.2744C35.173 26.7975 27.4435 34.5175 17.9088 34.5175C8.37399 34.5175 0.644531 26.7975 0.644531 17.2744C0.644531 7.75127 8.37399 0.03125 17.9088 0.03125C27.4435 0.03125 35.173 7.75127 35.173 17.2744Z" fill="#FFBB38"></path>
                                                    <path d="M18.0022 23.9937C19.8237 23.9937 21.6452 23.976 23.4668 23.9997C25.3 24.0234 26.571 22.7553 26.8873 21.3923C26.9575 21.102 26.9927 20.7938 26.9927 20.4916C27.0044 18.5006 26.9985 16.5095 26.9985 14.5184C26.9927 12.5096 25.5109 11.0044 23.5253 11.0044C19.8354 10.9985 16.1455 10.9985 12.4615 11.0044C10.4877 11.0044 9.00586 12.5155 9 14.5066C9 16.5036 9 18.5006 9 20.4975C9.00586 22.4412 10.4232 23.9463 12.3385 23.9819C14.2244 24.0175 16.1162 23.9878 18.0022 23.9937ZM15.6535 20.2783C15.6535 18.3998 15.6535 16.5628 15.6535 14.6962C17.2291 15.6325 18.7812 16.551 20.3626 17.4872C18.7753 18.4294 17.2291 19.342 15.6535 20.2783Z" fill="#222222">
                                                    </path>
                                                </svg>
                                            </span>
                                        </div>
                                ...
                                <div>
                                    <div className="write-review w-full mb-[30px]">
                                        <h1 className="text-2xl font-medium text-qblack mb-5">Leave a Comment</h1>
                                            ...
                                            <div className="sm:flex sm:space-x-[30px] items-center mb-5 w-full">
                                                ...
                                                <div className="w-full">
                                                    <div className="input-com w-full h-full">
                                                        ...
                                                        <div className="input-wrapper border border-qgray-border w-full h-full overflow-hidden relative ">
                                                            <input placeholder="" className="input-field placeholder:text-sm text-sm px-6 text-dark-gray w-full font-normal bg-white focus:ring-0 focus:outline-none h-[50px]" type="email" id="name" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="comment-item bg-white px-10 py-[32px] mb-2.5">
                                            <div className="comment-author flex justify-between items-center mb-3">
                                                <div className="flex space-x-3 items-center">
                                                    <div className="w-[50px] h-[50px] rounded-full overflow-hidden">
                                                        <Image src="https://shopo.quomodothemes.website/assets/images/comment-user-1.png" width={50} height={50} alt="" className="w-full h-full object-cover" />
                                                    </div>
                                                    <div>
                                            ...
                                            <div className="sub-comment-item bg-white px-10 pt-[32px] border-t">
                                                <div className="comment-author  mb-3">
                                                    <div className="flex space-x-3 items-center">
                                                        <div className="w-[50px] h-[50px] rounded-full overflow-hidden">
                                                            <Image src="https://shopo.quomodothemes.website/assets/images/comment-user-2.png" width={50} height={50} alt="" className="w-full h-full object-cover" />
                                                        </div>
                                                        <div>
                                                ...
                                                <div className="comment mb-[30px]">
                                                    <p className="text-[15px] text-qgray leading-7 text-normal">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div className="lg:w-[370px] w-full">
                        ...
                        <div className="search-widget w-full p-[30px] bg-white mb-[30px]">
                            ...
                            <div className="w-full h-[60px] relative">
                                <input type="text" placeholder="Search" className="w-full h-full bg-[#F9F3E9] focus:outline-none focus:ring-0 pl-5 pr-16 placeholder:text-qgraytwo" />
                                <span className="absolute right-5 top-[17px]">
                                    <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M0 9.59954C0.0526938 9.17184 0.105388 8.74414 0.184428 8.34317C0.526938 6.44524 1.34369 4.81463 2.60834 3.39787C4.08377 1.74052 5.92805 0.644534 8.0885 0.216832C10.6178 -0.291064 13.0154 0.0831754 15.2549 1.44648C17.7842 2.99689 19.3913 5.24233 19.9973 8.15605C20.5242 10.6421 20.129 13.0212 18.9171 15.2666C18.68 15.6943 18.68 15.6943 19.0225 16.0418C20.7877 17.8328 22.553 19.6238 24.3182 21.4148C24.8978 22.0029 25.1349 22.6712 24.9242 23.4731C24.529 24.9968 22.6583 25.5582 21.4727 24.3285C20.4715 23.286 19.4704 22.2969 18.4428 21.2544C17.6261 20.4257 16.8357 19.6238 16.0189 18.7951C15.9662 18.7417 15.9135 18.6882 15.8872 18.6615C15.2549 18.9823 14.6752 19.3565 14.0429 19.6238C11.3292 20.7733 8.58909 20.7465 5.90171 19.5169C3.873 18.5813 2.34487 17.1111 1.26465 15.1597C0.579632 13.9033 0.158081 12.5667 0.0526938 11.1232C0.0526938 11.043 0.0263469 10.9628 0 10.8826C0 10.4817 0 10.0272 0 9.59954ZM3.26702 10.2678C3.26702 14.0904 6.34961 17.1913 10.1172 17.1913C13.8848 17.1645 16.9147 14.0904 16.9411 10.2678C16.9411 6.47197 13.8585 3.3444 10.1172 3.3444C6.32326 3.3444 3.26702 6.44524 3.26702 10.2678Z" fill="#FFBB38"></path>
                                    </svg>
                                </span>
                            </div>
                        </div>
                        ...
                        <div className="latest-post-widget w-full bg-white p-[30px] mb-[30px] aos-init aos-animate">
                            ...
                            <ul className="flex flex-col space-y-5">
                                ...
                                <li className="flex space-x-5 items-center h-[95px]">
                                    <div className="w-[85px] h-full  overflow-hidden rounded">
                                        <Image src="https://shopo.quomodothemes.website/assets/images/blog-img-3.jpg" width={85} height={95} alt="blog" className="w-full h-full object-cover" />
                                    </div>
                                    <div className="flex-1 h-full flex flex-col justify-between">
                                        <p className="text-[18px] text-qblack leading-7 line-clamp-4">Panels with websites city connections</p>
                                        <div className="flex space-x-3 items-center">
                                            <span>
                                                <svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M0 2.81801C0.0698925 2.59859 0.108016 2.36327 0.212854 2.15974C0.571847 1.44423 1.16593 1.06263 1.9697 1.01811C2.19526 1.00539 2.424 1.01493 2.66544 1.01493C2.66544 0.852747 2.66544 0.700105 2.66544 0.550643C2.66544 0.229459 2.87512 0.00367645 3.17058 0.000496408C3.46603 0.000496408 3.67571 0.226279 3.67889 0.547463C3.67889 0.700105 3.67889 0.849567 3.67889 1.00857C4.44135 1.00857 5.1911 1.00857 5.9631 1.00857C5.9631 0.840027 5.95674 0.668305 5.9631 0.496583C5.97581 0.146778 6.30621 -0.0821846 6.63343 0.0291168C6.83358 0.0958976 6.97018 0.28034 6.97654 0.499763C6.98289 0.665125 6.97654 0.830487 6.97654 1.00539C7.74536 1.00539 8.50782 1.00539 9.28617 1.00539C9.28617 0.836847 9.27981 0.665125 9.28617 0.493402C9.30523 0.0958976 9.72776 -0.129885 10.0613 0.0799974C10.217 0.178579 10.2933 0.32168 10.2996 0.502943C10.3028 0.668305 10.2996 0.830487 10.2996 1.01493C10.4489 1.01493 10.5919 1.01811 10.7317 1.01493C11.0494 1.00857 11.3639 1.03083 11.6657 1.14531C12.4218 1.42515 12.9682 2.15974 12.9809 2.96747C12.9968 3.95647 12.9873 4.94864 12.9841 5.93763C12.9841 6.23019 12.7586 6.44962 12.479 6.44962C12.1931 6.44962 11.9738 6.22701 11.9738 5.92809C11.9707 4.98998 11.9738 4.04869 11.9738 3.11057C11.9738 2.67491 11.7959 2.34101 11.3988 2.14384C11.2845 2.0866 11.151 2.05162 11.0239 2.04526C10.7889 2.02936 10.5506 2.04208 10.2996 2.04208C10.2996 2.19472 10.2996 2.34737 10.2996 2.49683C10.2964 2.82755 10.0868 3.05651 9.78494 3.05333C9.48949 3.05015 9.28617 2.82437 9.28299 2.50001C9.28299 2.35373 9.28299 2.20426 9.28299 2.04844C8.51417 2.04844 7.75171 2.04844 6.97336 2.04844C6.97336 2.18836 6.97336 2.32511 6.97336 2.46503C6.97336 2.82119 6.77639 3.05333 6.46823 3.05333C6.16007 3.05651 5.95992 2.82437 5.95674 2.46821C5.95674 2.32829 5.95674 2.19154 5.95674 2.04526C5.19428 2.04526 4.44453 2.04526 3.67253 2.04526C3.67253 2.2138 3.67888 2.38553 3.67253 2.55407C3.65982 2.90387 3.32942 3.13284 3.00538 3.02471C2.80205 2.95793 2.66544 2.77031 2.66227 2.54135C2.65909 2.37917 2.66227 2.2138 2.66227 2.02618C2.36364 2.04208 2.07136 2.023 1.79497 2.07706C1.34066 2.15338 1.04203 2.55089 1.01662 3.02471C1.01344 3.05969 1.01662 3.09149 1.01662 3.12648C1.01662 5.71503 1.01662 8.30676 1.01662 10.8953C1.01662 11.3342 1.18817 11.6808 1.59164 11.8716C1.74731 11.9447 1.93157 11.9765 2.1063 11.9797C3.35484 11.9892 4.60019 11.9861 5.84873 11.9829C6.01393 11.9829 6.16007 12.0179 6.27761 12.1387C6.52224 12.3868 6.44599 12.8002 6.13148 12.9496C6.09335 12.9687 6.05523 12.9846 6.01711 13.0005C4.6129 13.0005 3.2087 13.0005 1.8045 13.0005C1.78543 12.9941 1.76637 12.9814 1.74731 12.9782C1.0325 12.8638 0.514663 12.479 0.203324 11.8302C0.108016 11.6331 0.0698925 11.4105 0.00317693 11.1974C0 8.40534 0 5.61327 0 2.81801Z" fill="#FFBB38"></path><path d="M9.6676 13.0009C9.3785 12.9278 9.07987 12.8833 8.8003 12.7815C7.48188 12.2981 6.64952 10.8385 6.89414 9.45837C7.11018 8.24042 7.80592 7.39771 8.97821 7.01928C10.1823 6.62814 11.2688 6.91434 12.1456 7.82701C12.9525 8.66972 13.194 9.69688 12.8541 10.8099C12.4919 11.996 11.6595 12.7116 10.4364 12.9532C10.3506 12.9691 10.2617 12.985 10.1759 13.0009C10.0044 13.0009 9.83598 13.0009 9.6676 13.0009ZM11.9741 9.92584C11.9741 8.79374 11.0432 7.86835 9.91541 7.87153C8.78759 7.87471 7.86946 8.79692 7.86628 9.92266C7.86311 11.0548 8.78759 11.9833 9.91858 11.9833C11.0496 11.9865 11.9772 11.0579 11.9741 9.92584Z" fill="#FFBB38"></path><path d="M3.67754 5.334C3.67754 5.61385 3.44562 5.84281 3.16605 5.83963C2.88648 5.83645 2.66092 5.6043 2.6641 5.32446C2.66727 5.05098 2.89601 4.8252 3.16923 4.8252C3.4488 4.8252 3.67754 5.05416 3.67754 5.334Z" fill="#FFBB38"></path><path d="M5.38258 5.83941C5.10301 5.84259 4.87427 5.61045 4.87109 5.33378C4.87109 5.05394 5.10301 4.82498 5.3794 4.82816C5.65262 4.83134 5.87818 5.05394 5.88453 5.32742C5.89089 5.60409 5.66215 5.83941 5.38258 5.83941Z" fill="#FFBB38"></path><path d="M8.0916 5.33696C8.0916 5.61681 7.85968 5.84577 7.58011 5.84259C7.30054 5.83941 7.07498 5.60727 7.07816 5.32742C7.08451 5.05394 7.31007 4.82816 7.58329 4.82816C7.86604 4.82498 8.09478 5.05712 8.0916 5.33696Z" fill="#FFBB38"></path><path d="M9.79737 5.83868C9.5178 5.83868 9.28906 5.60972 9.28906 5.32988C9.28906 5.05003 9.52098 4.82107 9.80055 4.82425C10.0738 4.82743 10.2993 5.05321 10.3025 5.3267C10.3057 5.60654 10.0769 5.83868 9.79737 5.83868Z" fill="#FFBB38"></path><path d="M3.16615 7.03519C3.44572 7.03201 3.67763 7.26097 3.67763 7.54082C3.67763 7.82066 3.44889 8.04962 3.16932 8.04962C2.89611 8.04962 2.66737 7.82384 2.66419 7.55036C2.65784 7.27051 2.88658 7.03837 3.16615 7.03519Z" fill="#FFBB38"></path><path d="M5.38331 8.04937C5.10374 8.05255 4.875 7.82041 4.875 7.54374C4.875 7.2639 5.10692 7.03494 5.38649 7.03812C5.6597 7.0413 5.88526 7.2639 5.88844 7.53738C5.89162 7.81405 5.66288 8.04619 5.38331 8.04937Z" fill="#FFBB38"></path><path d="M3.6778 9.76057C3.67144 10.0404 3.43635 10.263 3.15678 10.2567C2.87721 10.2503 2.65483 10.0118 2.66436 9.73195C2.67389 9.45846 2.9058 9.23904 3.17902 9.24222C3.45541 9.24858 3.68415 9.4839 3.6778 9.76057Z" fill="#FFBB38"></path><path d="M5.3794 10.2596C5.09983 10.2596 4.87109 10.0306 4.87109 9.75078C4.87109 9.47093 5.10301 9.24197 5.38258 9.24515C5.6558 9.24833 5.88136 9.47411 5.88453 9.7476C5.88771 10.0274 5.65897 10.2564 5.3794 10.2596Z" fill="#FFBB38"></path><path d="M10.4276 9.42294C10.5292 9.42294 10.6087 9.41976 10.6881 9.42294C10.9613 9.44202 11.1678 9.66462 11.1646 9.93492C11.1614 10.1989 10.9549 10.4215 10.6849 10.431C10.418 10.4405 10.1512 10.4405 9.88749 10.431C9.63016 10.4215 9.42366 10.2148 9.4173 9.954C9.40777 9.59148 9.40777 9.22577 9.4173 8.86325C9.42366 8.58659 9.64922 8.37988 9.91926 8.37988C10.1893 8.37988 10.4117 8.58977 10.4244 8.86325C10.4339 9.04451 10.4276 9.22577 10.4276 9.42294Z" fill="#FFBB38"></path>
                                ...
                                <li className="flex space-x-5 items-center h-[95px]">
                                    <div className="w-[85px] h-full  overflow-hidden rounded">
                                        <Image src="https://shopo.quomodothemes.website/assets/images/blog-img-4.jpg" width={85} height={95} alt="blog" className="w-full h-full object-cover" />
                                    </div>
                                    <div className="flex-1 h-full flex flex-col justify-between">
                                        <p className="text-[18px] text-qblack leading-7 line-clamp-4">Panels with websites city connections</p>
                                        <div className="flex space-x-3 items-center">
                        ...
                        <div data-aos="fade-up" className="categories-widget w-full bg-white p-[30px] mb-[30px]">
                            ...
                            <ul className="flex flex-col space-y-5">
                                <li className="flex justify-between items-center group">
                                    <span className="text-base text-qgraytwo group-hover:text-qyellow">Development</span>
                                    <span className="text-base text-qgraytwo group-hover:text-qyellow">(6)</span>
                                </li>
                                <li className="flex justify-between items-center group">
                                    <span className="text-base text-qgraytwo group-hover:text-qyellow">Guide</span>
                                    <span className="text-base text-qgraytwo group-hover:text-qyellow">(6)</span>
                                </li>
                                <li className="flex justify-between items-center group">
                                    <span className="text-base text-qgraytwo group-hover:text-qyellow">Inspiration</span>
                                    <span className="text-base text-qgraytwo group-hover:text-qyellow">(6)</span>
                                </li>
                                <li className="flex justify-between items-center group">
                                    <span className="text-base text-qgraytwo group-hover:text-qyellow">Latest News</span>
                                    <span className="text-base text-qgraytwo group-hover:text-qyellow">(6)</span>
                                </li>
                                <li className="flex justify-between items-center group">
                                    <span className="text-base text-qgraytwo group-hover:text-qyellow">Revenew</span>
                                    <span className="text-base text-qgraytwo group-hover:text-qyellow">(6)</span>
                                </li>
                                <li className="flex justify-between items-center group">
                                    <span className="text-base text-qgraytwo group-hover:text-qyellow">Start Up</span>
                                    <span className="text-base text-qgraytwo group-hover:text-qyellow">(6)</span>
                                </li>
                                <li className="flex justify-between items-center group">
                                    <span className="text-base text-qgraytwo group-hover:text-qyellow">Technology</span>
                                    <span className="text-base text-qgraytwo group-hover:text-qyellow">(6)</span>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div data-aos="fade-up" className="popular-tag-widget w-full bg-white p-[30px] mb-[30px]">
                            ...
                            <div className="filter-items">
                                <div className="flex gap-[10px] flex-wrap">
                                    <span className="text-base bg-[#F9F3E9] hover:bg-qyellow text-[#9A9A9A] hover:text-qblack px-[14px] py-[6px] cursor-pointer mb-[5px]">Agency</span>
                                    <span className="text-base bg-[#F9F3E9] hover:bg-qyellow text-[#9A9A9A] hover:text-qblack px-[14px] py-[6px] cursor-pointer mb-[5px]">Creative</span>
                                    <span className="text-base bg-[#F9F3E9] hover:bg-qyellow text-[#9A9A9A] hover:text-qblack px-[14px] py-[6px] cursor-pointer mb-[5px]">Data</span>
                                    <span className="text-base bg-[#F9F3E9] hover:bg-qyellow text-[#9A9A9A] hover:text-qblack px-[14px] py-[6px] cursor-pointer mb-[5px]">Technology</span>
                                    <span className="text-base bg-[#F9F3E9] hover:bg-qyellow text-[#9A9A9A] hover:text-qblack px-[14px] py-[6px] cursor-pointer mb-[5px]">Development</span>
                                    <span className="text-base bg-[#F9F3E9] hover:bg-qyellow text-[#9A9A9A] hover:text-qblack px-[14px] py-[6px] cursor-pointer mb-[5px]">Business</span>
                                    <span className="text-base bg-[#F9F3E9] hover:bg-qyellow text-[#9A9A9A] hover:text-qblack px-[14px] py-[6px] cursor-pointer mb-[5px]">Idea</span>
                                    <span className="text-base bg-[#F9F3E9] hover:bg-qyellow text-[#9A9A9A] hover:text-qblack px-[14px] py-[6px] cursor-pointer mb-[5px]">Generic</span>
                                </div>
                            </div>
                        </div>

                        <div data-aos="fade-up" className="w-full h-[358px] bg-newLetter bg-left-top bg-cover bg-no-repeat">
                            <div className="w-full h-full p-[30px] bg-black bg-opacity-75 flex flex-col justify-between"><div>
                                ...
                                <div><div className="w-full mb-3.5">
