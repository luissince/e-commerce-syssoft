...
import ProductCard from "./ui/component/product-card";
...
function GameStore() {
  return (
    <div data-aos="fade-up" className="section-style-one category-products mb-[60px]">
                  ...
                  <div className="flex-1 flex flex-col justify-center h-full">
                    <div>
                      ...
                      <button type="button" className="w-[110px] h-[30px]">
                        <span className="w-full h-full flex items-center justify-center text-sm font-semibold bg-search-btn text-black">
                          {" "}
                          Add To Cart
                        </span>
                      </button>
          ...
          <div className="section-content">
            <div className="products-section w-full">
              <div className="grid xl:grid-cols-4 lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 xl:gap-[30px] gap-5">
                ...
                <ProductCard
                  image={"/assets/product-img-7.jpg"}
                  width={200}
                  height={200}
                  title={"Xoggle aute et pariatur adipisicing nostrud et excepteur"}
                  priceOld={"32.63"}
