...
export async function importClientComponents() {
    ...
    switch (clientName) {
        case 'default':
            const [HeaderClient1, FooterClient1, MainClient1, AllProductsClient1, SingleProductClient1, PrivacyPolicyClient1, TermsConditionClient1, AboutClient1, ContactClient1, CartClient1, WishListClient1, CheckoutClient1] = await Promise.all([
                ...
                import('@/app/ui/wishlist/default'),
            ...
            return {
                ...
                WishList: WishListClient1.default, Checkout: CheckoutClient1.default,
            };

        case 'import-muneli':
            const [HeaderClient2, FooterClient2, MainClient2, AllProductsClient2, SingleProductClient2, PrivacyPolicyClient2, TermsConditionClient2, AboutClient2, ContactClient2, CartClient2, WishListClient2, CheckoutClient2] = await Promise.all([
                ...
                import('@/app/ui/wishlist/import-muneli'),
            ...
            return {
                ...
                WishList: WishListClient2.default, Checkout: CheckoutClient2.default,
            };
