...
function SubmitButton() {
    ...
    return (
        <button
            className="bg-black text-white text-sm font-semibold w-full h-[50px] flex justify-center items-center"
            type="submit"
            disabled={pending}
        >
        ...
        <>
            <div className="mb-4">
                <div className="input-com w-full h-full">
                    <label className="input-label capitalize block  mb-2 text-qgray text-xs font-normal" htmlFor="name">Nombres*</label>
            ...
            <div className="mb-4">
                <div className="input-com w-full h-full">
                    <label className="input-label capitalize block  mb-2 text-qgray text-xs font-normal" htmlFor="email">Email*</label>
                    <div className="input-wrapper border border-qgray-border w-full h-full overflow-hidden relative ">
                        <input
                            type="email"
            ...
            <div className="mb-4">
                <div className="input-com w-full h-full">
                    <label className="input-label capitalize block  mb-2 text-qgray text-xs font-normal" htmlFor="number">Teléfono*</label>
                    <div className="input-wrapper border border-qgray-border w-full h-full overflow-hidden relative ">
                        <input
                            type={inputType}
            ...
            <div className="mb-5">
                <label className="input-label text-qgray capitalize text-xs font-normal block mb-2" htmlFor="message">Mensaje*</label>
                <textarea
