    ...
    return (
        <>
            <div className="price-range mb-5">
                <div className="h-[5px] relative bg-[#d4d4d4] rounded-md">
                    <div className="bg-[#f76d24] absolute h-full rounded-md left-[25%] right-[25%]" ref={refContentSlider}></div>
                </div>
            ...
            <p className="text-xs text-black font-400">Price: S/ {minRange} - S/ {maxRange}</p>
        </>
    );
}