...
const Tab: React.FC<ProductModel> = (product) => {
            ...
            <div className="tab-buttons w-full mb-10 mt-5 sm:mt-0">
                <div className="container max-w-screen-x mx-auto px-2 md:px-6">
                    <ul className="flex space-x-12 ">
                        <li onClick={() => setTab(0)}>
                            <span className={`py-[15px] sm:text-[15px] text-sm sm:block border-b font-medium cursor-pointer ${tab === 0 ? 'border-qyellow text-qblack dark:text-white' : 'border-transparent text-qgray'}  `}>Description</span>
                        </li>
                        <li onClick={() => setTab(1)}>
                            <span className={`py-[15px] sm:text-[15px] text-sm sm:block border-b font-medium cursor-pointer ${tab === 1 ? 'border-qyellow text-qblack dark:text-white' : 'border-transparent text-qgray'} `}>Detail</span>
                        </li>
                        {/* <li onClick={() => setTab(2)}>
